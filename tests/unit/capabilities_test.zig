...
test "capabilities describe current phase-2 semantics truthfully" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, buffer.items, "\"secureClientModes\":\"trds-wtp-htp-ht2-ht1\"") != null);
    ...
    if (builtin.os.tag == .windows) {
        ...
        try std.testing.expect(std.mem.indexOf(u8, buffer.items, "\"implementedTransports\":[\"unix-domain-socket\",\"tcp\",\"http\",\"h2\",\"https\",\"h3wt\"]") != null);
    }
